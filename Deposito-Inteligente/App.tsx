  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        />
        <Stack.Screen
          options={{ title: 'Cadastrar Novo Usuário', headerTintColor: '#FFF' }}
          name="CriarUsuario"
          component={CriarUsuario}
        />
        <Stack.Screen
          options={{ title: 'Recuperar Senha', headerTintColor: '#FFF' }}
          name="EsqueceuSenha"
        ...
        <Stack.Screen
          options={({ navigation }) => ({
            ...
            headerLeft: () => (
              <TouchableOpacity
                onPress={() => navigation.navigate('Carrinho', { shoppingcart })}
              >
        ...
        >
          {({ route }) => (
            <Carrinho route={route} shoppingcart={shoppingcart} setShoppingCart={setShoppingCart} />
          )}
        </Stack.Screen>
        <Stack.Screen
          options={{
